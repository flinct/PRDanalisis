...
> **Version:** `v1.1`  
> **Previous Version:** `Assessments/company-n-people/roles-management-custom-rbac/versions/roles-management-custom-rbac-qa-assessment-v1.0.md`  
...
- Revisi dari v1.0 dengan tambahan **service-level impact analysis** berdasarkan masukan teknis terbaru.
- Menambahkan **API Gateway / authorization middleware / guard layer** sebagai enforcement choke point yang wajib dianalisis terpisah dari Auth Service.
- Menegaskan bahwa concern `Team` valid, tetapi ownership teknisnya lebih tepat diposisikan sebagai **cross-service dependency** (People ↔ Company/Team/Team Inbox), bukan murni subdomain People saja.
...
**Business Context:**  
Current product sudah punya role-sensitive behavior di Conversation, Ticket, Contacts, Analytics, Broadcast, Leads, Team Inbox, dan Settings. Karena itu perubahan RBAC editor akan mempengaruhi **runtime authorization**, **data visibility**, **masking**, **session refresh**, **query scoping**, dan **auditability** di banyak modul sekaligus.
...
**Decision Statement:**
> Arah feature ini benar dan bernilai tinggi, tetapi belum aman untuk langsung dibawa ke versi berikutnya karena masih ada gap mendasar pada contract enforcement, migration, scope resolution, permission propagation, middleware/gateway authorization choke point, dan privacy masking lintas-surface. Tanpa penguncian kontrak tersebut, risiko access leak, stale permission, partial update, dan regression lintas service terlalu besar.
